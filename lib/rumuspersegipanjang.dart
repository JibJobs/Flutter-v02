...
class rumuspersegipanjang extends StatefulWidget {
  const rumuspersegipanjang({Key? key}) : super(key: key);

  @override
  State<rumuspersegipanjang> createState() => _rumuspersegipanjangState();
}

class _rumuspersegipanjangState extends State<rumuspersegipanjang> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Rumus Persegi Panjang"),),
      body: Container(
        ...
        child: Column(
          ...
          children:[
            ...
            Align(
              ...
              child: Text(
                "Hasil : ${ctrHasil.text}cm", style: TextStyle(fontSize: 20, fontWeight:FontWeight.bold, color: Colors.blueAccent,),
